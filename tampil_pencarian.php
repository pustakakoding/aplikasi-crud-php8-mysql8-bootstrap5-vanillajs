    ...
    ?>
        <div class="col-12">
            <div class="alert alert-primary rounded-4 mb-5" role="alert">
                <i class="fa-solid fa-hand-point-right me-2"></i> Hasil Pencarian <span class="fw-bold fst-italic">"<?= $kata_kunci ?>"</span>
            </div>
        </div>
                ...
                <div class="p-2">
                    <div class="d-flex bg-white rounded-4 shadow-sm">
                        <div class="flex-shrink-0 p-3">
                            <img src="images/<?= basename($data['foto_profil']) ?>" class="border border-2 img-fluid rounded-4" alt="Foto Profil" width="100" height="100" loading="lazy">
                        </div>
                        ...
                        <div class="p-4">
                            <div class="d-flex flex-column flex-lg-row">
                                ...
                                <a href="?halaman=detail&id=<?= $data['id_siswa'] ?>" class="btn btn-primary btn-sm rounded-pill px-3 me-2 mb-2 mb-lg-0"> Detail </a>
                                <!-- button form ubah data -->
                                <a href="?halaman=ubah&id=<?= $data['id_siswa'] ?>" class="btn btn-success btn-sm rounded-pill px-3 me-2 mb-2 mb-lg-0"> Ubah </a>
        ...
        // jika data siswa tidak ada
            ...
            <div class="col-12">
                ...
                Data siswa dengan kata kunci <span class="text-primary fst-italic px-2">"<?= $kata_kunci ?>"</span> tidak ditemukan.
            </div>
    <?php
        }
    }
